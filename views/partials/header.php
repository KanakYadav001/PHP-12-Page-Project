<?php
// filepath: C:\Users\kanka\PHP-PROJECT-12Page\views\partials\header.php
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <nav class="navbar navbar-expand-lg bg-light mb-3">
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav">
          <?php if ($u): ?>
            <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>index.php?page=profile"><?= e($u['name']) ?></a></li>
            <li class="nav-item">
              <form method="post" action="<?= BASE_URL ?>actions/auth_logout.php">
